...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col items-center justify-center  h-[80vh] w-full px-6 pb-4">
      <div className="flex flex-col w-full items-center lg:flex-row lg:justify-between lg:items-center lg:space-x-[110px">
        ...
        <div className="order-2 lg:order-1 flex-grow-0 text-center mt-8 lg:mt-0 max-w-sm">
          <h1 className="text-darkcolor text-[32px] lg:text-[44px] font-bold">
            Hi, I am Bright, <br />A Web Developer
          </h1>
          <p className="mt-2 lg:mt-10 text-darkcolor">
      ...
      >
        <button
          type="button"
          className="bg-primary text-white rounded-sm py-2 w-52 mt-3 lg:mt-9"
        >
          Download Resume
        </button>
      </Link>
